...
class OvirtNodeNgN40Spider(CrawlSpider):
    name = "ovirtnodengn40"
    allowed_domains = ['ovirt.org']
    start_urls = ["http://jenkins.ovirt.org/job/ovirt-node-ng_ovirt-4.0_build-artifacts-fc22-x86_64/lastSuccessfulBuild/artifact/exported-artifacts/"]

    def __init__(self, *args, **kwargs):
        super(OvirtNodeNgN40Spider, self).__init__(*args, **kwargs)
