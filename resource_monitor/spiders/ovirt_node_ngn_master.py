...
class OvirtNodeNgNMasterSpider(CrawlSpider):
    name = "ovirtnodengnmaster"
    allowed_domains = ['ovirt.org']
    start_urls = ["http://jenkins.ovirt.org/job/ovirt-node-ng_master_build-artifacts-fc22-x86_64/lastSuccessfulBuild/artifact/exported-artifacts/"]

    def __init__(self, *args, **kwargs):
        super(OvirtNodeNgNMasterSpider, self).__init__(*args, **kwargs)
